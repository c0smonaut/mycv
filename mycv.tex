...
\moveleft.20\hoffset\rightline{email: alexander.vynnyk@protonmail.com} % email
...
{\bf Virtualization/Containers/Cloud:} Xen, Docker (+Compose), AWS, Kubernetes \\
...
{\bf Sr. DevOps Engineer} \hfill February 2020 --- Present \\
{\sl Company Name:} Global Logic Ukraine \\
{\sl URL:} \url{https://www.globallogic.com/} \\
{\sl Working with:} Linux, AWS, kubernetes (eks), docker, shell/python \\
{\sl Main tasks:}
\begin{itemize}
\item Design, development and support of cloud infrastructure and services
\item Interaction with developers
\end{itemize}

{\bf Sr. DevOps Engineer} \hfill April 2016 --- January 2020 \\
{\sl Company Name:} Ciklum \\
{\sl URL:} \url{https://ciklum.com} \\
{\sl Working with:} Linux (RedHat6/7) opscode chef, java stack (IBM websphere, JBoss, tomcat/springboot), terraform, jenkins, ruby, python, build tools \\
{\sl Main tasks:}
\begin{itemize}
...
{\sl StumpWM --- common lisp window manager:} \hfill November 2010 \\ \url{https://github.com/stumpwm/stumpwm} \\ \\
...
{\sl PDP3 --- plasma simulation application (as part of PhD scientific research):} \hfill June 2017 --- November 2019 \\ \url{https://github.com/cosmonaut-ok/pdp3} \\ \\
...
{\sl Various contributions to community opensource emacs modules and opscode chef cookbooks}

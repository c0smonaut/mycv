...
{\sl StumpWM - common lisp window manager(\url{https://github.com/stumpwm/stumpwm}):} \hfill November 2010 - Present \\
{\sl DSWM - stumpwm fork (\url{http://dss-project.org/dswm}):} \hfill November 2010 - November 2016 \\
{\sl cl-jabs - maven-like build tool for common lisp ecosystem (\url{https://github.com/cl-jabs/cl-jabs}):} \hfill January 2017 - Present \\
{\sl PDP3 - plasma physics simulation application (\url{https://github.com/cosmonaut-ok/pdp3}):} \hfill June 2017 - Present \\
